...
*/
    ...
    e.prototype.set = function (h, k) {
      ...
      l.entry
        ...
        : ((l.entry = {
          ...
          l.list.push(l.entry),
          (this.g.previous.next = l.entry),
          (this.g.previous = l.entry),
          this.size++);
      return this;
    };
  ...
  Gc.prototype.sizeBytes = function () {
    ...
    null == a ||
      Cc(a) ||
      ('string' === typeof a ? (a = zc(a)) : (Na(a), (a = null)));
  ...
  function Mc(a, b) {
    Object.isExtensible(a) &&
      (Hc ? a[Hc] && (a[Hc] &= ~b) : void 0 !== a.L && (a.L &= ~b));
  }
  ...
  function bd(a, b) {
    if (!(a instanceof b))
      throw Error(
        'Expected instanceof ' + ad(b) + ' but got ' + (a && ad(a.constructor))
      );
    return a;
  }
  ...
  function id(a, b, c) {
    return -1 === b
      ...
      ? a.D
        ? a.D[b]
        : void 0
      : (void 0 === c ? 0 : c) && a.D && ((c = a.D[b]), null != c)
      ? c
      : a.o[b + a.R];
  }
  ...
  function J(a, b, c, d, e) {
    ...
    void 0 !== a.D && a.V >= a.o.length
      ? ((d = a.o.length - 1),
        (e = b + a.R),
        e >= d
          ? ((a.o[d] = void 0), (a.o[e] = c), a.o.push(a.D))
          : (a.o[e] = c))
      : (a.o[b + a.R] = c);
  ...
  function jd(a, b, c, d) {
    ...
    if (I(a.o)) f & 2 || Lc(e, 2), c & 1 || Object.freeze(e);
      ...
      (e = Oc(Array.prototype.slice.call(e))), J(a, b, e, d);
    else if (!(c & 2) && f & 16) {
      a = e;
      if (!Array.isArray(a))
  ...
  function od(a, b, c, d, e) {
    ...
    if (f)
      h ||
        (Object.isFrozen(f)
          ? e || ((f = Array.prototype.slice.call(f)), (a.g[c] = f))
          : e && Object.freeze(f));
    else {
      f = [];
      var k = !!(H(a.o) & 16),
      ...
      a = g;
      b = !d;
      Object.isFrozen(a) || ((c = H(a) | 33), Nc(a, b ? c | 8 : c & -9));
      (h || (e && l)) && Lc(f, 2);
      (h || e) && Object.freeze(f);
    }
    return f;
  ...
  function ud(a, b) {
    if (null != a) {
      if (Bc && a instanceof Uint8Array)
        return a.length ? new Gc(new Uint8Array(a)) : Ec || (Ec = new Gc(null));
      if (Array.isArray(a)) {
        if (I(a)) return a;
  ...
  function wd(a, b, c, d, e, f) {
    (a = a.g && a.g[c])
      ? ((d = 0 < a.length ? a[0].constructor : void 0),
        (I(a) && Object.isFrozen(a)) ||
          ((f = cb(a, vd)), Sc(a, f), Object.freeze(f), (a = f)),
        qd(b, d, c, a, e))
      : J(b, c, ud(d, f), e);
  }
  ...
  function N(a, b, c) {
    ...
    a: {
      ...
      if (f && ((f = this.o[d]), Uc(f))) {
        this.D = f;
        b = Object.keys(f);
        0 < b.length && eb(b, isNaN)
          ? (this.V = Number.MAX_VALUE)
          : (this.V = d - this.R);
        break a;
      }
      void 0 !== b && -1 < b
        ? ((this.V = Math.max(b, d + 1 - this.R)), (this.D = void 0))
        : (this.V = Number.MAX_VALUE);
    }
    ...
    if (c)
      for (e = h && !g ? Pc : Oc, b = 0; b < c.length; b++)
        (h = c[b]),
          (g = id(this, h)) ? Array.isArray(g) && e(g) : J(this, h, Zc, !1, !0);
  }
            ...
            if (e.length) {
              ...
              if (h) {
                for (h = 0; h < f.length; h++)
                  (l = f[h]) && I(l.o) && ((f[h] = nd(f[h])), (g[h] = f[h].o));
                Lc(g, 8);
              }
              for (g = 0; g < Math.min(f.length, e.length); g++) Bd(f[g], e[g]);
            }
          } else throw Error('unexpected object: type: ' + Na(e) + ': ' + e);
        }
      }
    }
  }
...
*/
    ...
    function b(p) {
      ...
      for (q = 0; 80 > q; q++) {
        if (40 > q)
          ...
          60 > q
            ? ((M = (w & A) | (G & (w | A))), (O = 2400959708))
            : ((M = w ^ A ^ G), (O = 3395469782));
        M =
          ((((p << 5) | (p >>> 27)) & 4294967295) + M + K + O + t[q]) &
          4294967295;
        K = G;
        G = A;
  ...
  function me(a) {
    ...
    e &&
      ...
      c &&
        ke(b) &&
        ((b = le('__1PSAPISID', '__Secure-1PAPISID', 'SAPISID1PHASH', a)) &&
          d.push(b),
        (a = le('__3PSAPISID', '__Secure-3PAPISID', 'SAPISID3PHASH', a)) &&
          d.push(a)));
  ...
  var pe = (function () {
    ...
    try {
      z.addEventListener('test', function () {}, b),
        z.removeEventListener('test', function () {}, b);
    } catch (c) {}
    return a;
  })();
  ...
  we.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.ta = !1))
      : ((b = new ue(b, this.src, f, !!d, e)), (b.ta = c), a.push(b));
    return b;
  };
  ...
  function ye(a, b) {
    ...
    c in a.listeners &&
      fb(a.listeners[c], b) &&
      (ve(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.g--));
  }
  ...
  function De(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (c = Ee(c)),
        a && a[se]
          ? a.g.add(String(b), c, !0, Pa(d) ? !!d.capture : !!d, e)
          : Fe(a, b, c, !0, d, e);
  }
  ...
  function Ke(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      ((d = Pa(d) ? !!d.capture : !!d), (c = Ee(c)), a && a[se])
    ...
    if ('number' !== typeof a && a && !a.ka) {
      ...
      if (b && b[se]) ye(b.g, a);
        ...
        b.removeEventListener
          ...
          : b.detachEvent
          ? b.detachEvent(Ie(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
        Be--;
        (c = Ge(b))
          ? (ye(c, a), 0 == c.g && ((c.src = null), (b[ze] = null)))
          : ve(a);
      }
    }
  }
            ...
            switch (h.g) {
              ...
              case 3:
                ...
                g !== a.h &&
                  ((a.h = g),
                  a.h
                    ? Oe(a, 'networkstatus-online')
                    : Oe(a, 'networkstatus-offline'));
                c(g);
                Ba(h);
                break;
              case 2:
        ...
        bf(
          Ze(
            gf(
              af(
                hf(
                  cf($e(new Xe(), a.architecture || ''), a.bitness || ''),
                  a.mobile || !1
                ),
                a.model || ''
              ),
  ...
  Ff.prototype.update = function (a, b) {
    if (null != a) {
      ...
      for (var c = b - this.blockSize, d = 0, e = this.m, f = this.h; d < b; ) {
        if (0 == f) for (; d <= c; ) Gf(this, a, d), (d += this.blockSize);
        if ('string' === typeof a)
          for (; d < b; ) {
  ...
  n.delete = function (a) {
    return ng(this.h, a)
      ? (delete this.h[a],
        --this.size,
        this.i++,
        this.g.length > 2 * this.size && mg(this),
        !0)
      : !1;
  };
  ...
  function mg(a) {
    ...
    if (a.size != a.g.length) {
      ...
      for (c = b = 0; b < a.g.length; )
        (d = a.g[b]), ng(e, d) || ((a.g[c++] = d), (e[d] = 1)), b++;
      a.g.length = c;
    }
  }
  n.get = function (a, b) {
  ...
  function Ag(a, b, c, d) {
    if (3 == c && b.h && !b.j) for (; a && a.m; a = a.i) a.m = !1;
  ...
  n.K = function (a) {
    ...
    d.next = function () {
      ...
      var e = c[b++];
      if (a)
        return Jf(decodeURIComponent(e.nodeName.replace(/\./g, '%')).slice(1));
      e = e.nodeValue;
      if ('string' !== typeof e)
        throw 'Storage mechanism: Invalid value was encountered';
      return Jf(e);
  ...
  v(Ch, N);
  var Dh = [
    23, 24, 11, 6, 7, 5, 2, 3, 13, 20, 21, 22, 28, 32, 37, 229, 241, 45, 59,
    225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97,
    100, 102, 105, 119, 126, 127, 136, 146, 148, 151, 157, 158, 159, 163, 164,
    168, 444, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193,
    194, 195, 196, 197, 198, 199, 200, 201, 402, 320, 203, 204, 205, 206, 258,
    259, 260, 261, 327, 209, 219, 226, 227, 232, 233, 234, 240, 244, 247, 248,
    249, 251, 256, 257, 266, 254, 255, 270, 272, 278, 291, 293, 300, 304, 308,
    309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 334, 337,
    338, 340, 344, 348, 350, 351, 352, 353, 354, 355, 356, 357, 358, 361, 363,
    364, 368, 369, 370, 373, 374, 375, 378, 380, 381, 388, 389, 403, 410, 412,
    429, 413, 414, 415, 416, 417, 418, 430, 423, 424, 425, 426, 427, 431, 117,
    439, 441, 448,
  ];
  ...
  var Jh = z.window,
    ...
    Lh,
    Mh =
      (null == Jh ? void 0 : null == (Kh = Jh.yt) ? void 0 : Kh.config_) ||
      (null == Jh ? void 0 : null == (Lh = Jh.ytcfg) ? void 0 : Lh.data_) ||
      {};
  B('yt.config_', Mh);
  ...
  function Nh() {
    ...
    1 < a.length
      ? (Mh[a[0]] = a[1])
      : 1 === a.length && Object.assign(Mh, a[0]);
  }
  ...
  function Th(a, b, c, d) {
    ...
    e
      ? e(a, 'ERROR', b, c, d)
      : ((e = R('ERRORS', [])), e.push([a, 'ERROR', b, c, d]), Nh('ERRORS', e));
    Rh(a);
  }
  ...
  function ni(a) {
    ...
    c && d
      ...
      : (a = d
          ? Vb(b) == d &&
            (Number(b.match(Tb)[4] || null) || null) ==
              (Number(a.match(Tb)[4] || null) || null)
          : !0);
    return a;
  }
  ...
  function ri(a) {
    ...
    try {
      ...
      var p;
      e.u_aw = null == (p = Cd.screen) ? void 0 : p.availWidth;
      var t;
    ...
    try {
      var sa = (w || window).document,
        Y = 'CSS1Compat' == sa.compatMode ? sa.documentElement : sa.body;
    ...
    b =
      ...
      (da.wgl = !!Cd.WebGLRenderingContext),
      da);
    c = d.call(c, e, b);
    c.ca_type = 'image';
    a && (c.bid = a);
  ...
  function zi(a) {
    ...
    T('debug_handle_relative_url_for_query_forward_killswitch') ||
      (!c && ni(a) && (c = document.location.hostname));
  ...
  function Ci(a, b) {
    ...
    b.excludeXsrf ||
      (Vb(a) && !b.withCredentials && Vb(a) != document.location.hostname) ||
      'POST' != b.method ||
    ...
    !xi &&
      a &&
      'POST' != b.method &&
      ((xi = !0), Th(Error('AJAX request with postData should use POST')));
    return e;
  }
  ...
  function Ei(a, b, c, d) {
    ...
    switch (b) {
      case 'JSON':
        ...
        break;
      case 'XML':
        if ((a = (a = c.responseXML) ? Fi(a) : null))
          (e = {}),
  ...
  function Yi(a) {
    ...
    (b = c ? (a ? new Yg(b, a) : b) : null) ||
      ((a = new Tg(a || 'UserDataSharedStore')), (b = a.g ? a : null));
  ...
  Yi.prototype.get = function (a, b) {
    ...
    if (d && (c = je.get('' + a, void 0)) && ((c = unescape(c)), b))
      try {
        c = JSON.parse(c);
      } catch (e) {
  ...
  var gj = {},
    hj =
      ((gj.AUTH_INVALID = 'No user identifier specified.'),
      (gj.EXPLICIT_ABORT = 'Transaction was explicitly aborted.'),
      (gj.IDB_NOT_SUPPORTED = 'IndexedDB is not supported.'),
      (gj.MISSING_INDEX = 'Index not created.'),
      (gj.MISSING_OBJECT_STORES = 'Object stores not created.'),
      (gj.DB_DELETED_BY_MISSING_OBJECT_STORES =
        'Database is deleted because expected object stores were not created.'),
      (gj.DB_REOPENED_BY_MISSING_OBJECT_STORES =
        'Database is reopened because expected object stores were not created.'),
      (gj.UNKNOWN_ABORT = 'Transaction was aborted for unknown reasons.'),
      (gj.QUOTA_EXCEEDED =
        'The current transaction exceeded its quota limitations.'),
      (gj.QUOTA_MAYBE_EXCEEDED =
        'The current transaction may have failed because of exceeding quota limitations.'),
      (gj.EXECUTE_TRANSACTION_ON_CLOSED_DB =
        "Can't start a transaction on a closed database"),
      (gj.INCOMPATIBLE_DB_VERSION =
        'The binary is incompatible with the database version'),
      gj),
    ij = {},
    jj =
      ((ij.AUTH_INVALID = 'ERROR'),
      (ij.EXECUTE_TRANSACTION_ON_CLOSED_DB = 'WARNING'),
      (ij.EXPLICIT_ABORT = 'IGNORED'),
      (ij.IDB_NOT_SUPPORTED = 'ERROR'),
      (ij.MISSING_INDEX = 'WARNING'),
      (ij.MISSING_OBJECT_STORES = 'ERROR'),
      (ij.DB_DELETED_BY_MISSING_OBJECT_STORES = 'WARNING'),
      (ij.DB_REOPENED_BY_MISSING_OBJECT_STORES = 'WARNING'),
      (ij.QUOTA_EXCEEDED = 'WARNING'),
      (ij.QUOTA_MAYBE_EXCEEDED = 'WARNING'),
      (ij.UNKNOWN_ABORT = 'WARNING'),
      (ij.INCOMPATIBLE_DB_VERSION = 'WARNING'),
      ij),
    kj = {},
    lj =
      ((kj.AUTH_INVALID = !1),
      (kj.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1),
      (kj.EXPLICIT_ABORT = !1),
      (kj.IDB_NOT_SUPPORTED = !1),
      (kj.MISSING_INDEX = !1),
      (kj.MISSING_OBJECT_STORES = !1),
      (kj.DB_DELETED_BY_MISSING_OBJECT_STORES = !1),
      (kj.DB_REOPENED_BY_MISSING_OBJECT_STORES = !1),
      (kj.QUOTA_EXCEEDED = !1),
      (kj.QUOTA_MAYBE_EXCEEDED = !0),
      (kj.UNKNOWN_ABORT = !0),
      (kj.INCOMPATIBLE_DB_VERSION = !1),
      kj);
    ...
    return new uj(
      new tj(function (f, g) {
        'PENDING' === c.state.status
          ...
          ? vj(c, c, d, f, g)
          : 'REJECTED' === c.state.status && wj(c, c, e, f, g);
      })
    );
  };
  ...
  var Dj = window,
    V =
      Dj.ytcsi && Dj.ytcsi.now
        ? Dj.ytcsi.now
        : Dj.performance &&
          Dj.performance.timing &&
          Dj.performance.now &&
          Dj.performance.timing.navigationStart
        ? function () {
    ...
    return y(function (G) {
      switch (G.g) {
        ...
        case 4:
          ...
          if ((A = w instanceof U && !w.g) || g >= f)
            zk(a, k, q, g, w, b.join(), e), (h = w);
          G.v(2);
          break;
        case 3:
    ...
    e
      ? (e instanceof U &&
        ...
        e instanceof U &&
          ...
          dj('TRANSACTION_UNEXPECTEDLY_ABORTED', {
            objectStoreNames: f,
        ...
        switch (A.g) {
          case 1:
            return (
              ...
              wa(A, 2),
              x(A, a.i(a.name, a.options.version, d), 4)
            );
          case 4:
            h = A.h;
            for (
              var G = a.options, K = [], M = u(Object.keys(G.ja)), O = M.next();
              !O.done;
              O = M.next()
            ) {
              O = O.value;
              ...
              !(h.g.version >= kb.Ia) ||
                h.g.version >= pc ||
                h.g.objectStoreNames.contains(O) ||
                K.push(O);
            }
            k = K;
            if (0 === k.length) {
            ...
            if (a.l < pi('ytidb_reopen_db_retries', 0))
              return (
                a.l++,
                h.close(),
                cj(
          ...
          case 10:
            throw (
              ...
              pj(p, a.name, '', null != (w = a.options.version) ? w : -1))
            );
        }
      });
    }
          ...
          function (e) {
            ...
            return f.get(a.actualName).then(function (g) {
              if (
                ...
                return Bj(f.g.put(a, void 0)).then(function () {});
            });
          }
        )
      );
  ...
  function Xk() {
    ...
    return (Uk = Wk().then(function (a) {
      ...
      if (null != (b = Zi()) && b.g) {
        ...
        b = {
          hasSucceededOnce:
            (null == (c = $i()) ? void 0 : c.hasSucceededOnce) || a,
        };
        var d;
  ...
  function dl(a, b, c) {
    a = a.map(function (d) {
      return y(function (e) {
        return 1 == e.g
          ? x(e, Jk(d.actualName, b), 2)
          : x(e, Rk(d.actualName, c), 0);
      });
    });
  ...
  function ml(a) {
    ...
    for (
      var d = b.client,
        e = {},
        f = u(Object.entries(li(R('DEVICE', '')))),
        g = f.next();
      !g.done;
      g = f.next()
    ) {
  ...
  function sl(a) {
    ...
    R('DELEGATED_SESSION_ID') &&
      !T('pageid_as_header_web') &&
      ((a = new jh()), J(a, 3, R('DELEGATED_SESSION_ID')));
    ...
    if ('WEB' === a || 'MWEB' === a || 1 === a || 2 === a)
      if (b) {
        ...
        c &&
          ...
          (c.client.mainAppWebInfo.webDisplayMode = Ii()));
  }
  ...
  function ol(a, b) {
    ...
    if (
      ...
      (null == (c = z.navigator) ? 0 : c.deviceMemory)
    ) {
      var d;
  ...
  function ql(a, b) {
    ...
    d && (a ? J(a, 61, Ki[d]) : b && (b.client.connectionType = d));
    T('web_log_effective_connection_type') &&
      ((d = Ni()),
      (d =
        null != d && d.effectiveType
          ? Mi.hasOwnProperty(d.effectiveType)
            ? Mi[d.effectiveType]
            : 'EFFECTIVE_CONNECTION_TYPE_UNKNOWN'
          : void 0),
      d && (a ? J(a, 94, Li[d]) : b && (b.client.effectiveConnectionType = d)));
  }
  ...
  function tl(a, b, c) {
    ...
    (b = c.Zb || R('AUTHORIZATION')) ||
      (a ? (b = 'Bearer ' + C('gapi.auth.getToken')().Yb) : (b = me([])));
    b &&
      ((d.Authorization = b),
      (d['X-Goog-AuthUser'] = R('SESSION_INDEX', 0)),
      T('pageid_as_header_web') &&
        (d['X-Goog-PageId'] = R('DELEGATED_SESSION_ID')));
    return d;
  }
    ...
    if (c && e && d)
      if (a) {
        ...
        b &&
          ...
          (b.client.configInfo.coldHashData = e),
          (b.client.configInfo.hotHashData = d));
  }
  ...
  function Dl(a) {
    Cl(a) &&
      !a.ha &&
      ((a.g = !0),
      a.xa && Math.random() <= a.wa && a.C.pb(a.u),
      El(a),
      a.F.I() && a.ma(),
      a.F.X(a.Na, a.ma.bind(a)),
      a.F.X(a.Ma, a.Ra.bind(a)));
  }
  n = Bl.prototype;
  ...
  n.sendThenWrite = function (a, b, c) {
    ...
    if (Cl(this) && this.g) {
      ...
      if (
        this.F.I() ||
        (this.A && this.A('nwl_aggressive_send_then_write') && !e.skipRetry)
      ) {
        if (!e.skipRetry) {
          ...
          b.onError = function (g, h) {
            return y(function (k) {
              if (1 == k.g)
                return x(
                  k,
                  d.C.set(e, d.u).catch(function (l) {
                    Gl(d, l);
                  }),
                  2
                );
        ...
        this.C.set(e, this.u).catch(function (g) {
          d.O(a, b, e.skipRetry);
          Gl(d, g);
        });
  ...
  n.ma = function () {
    ...
    this.h ||
      (this.h = this.J.P(function () {
        var b;
        return y(function (c) {
          if (1 == c.g) return x(c, a.C.Va('NEW', a.u), 2);
          if (3 != c.g)
            return (b = c.h), b ? x(c, Fl(a, b), 3) : (a.Ra(), c.return());
          a.h && ((a.h = 0), a.ma());
          c.g = 0;
        });
      }, this.ib));
    ...
    return y(function (e) {
      switch (e.g) {
        ...
        case 3:
          (d = e.h)
            ? (b = d)
            : a.da(Error('The request cannot be found in the database.'));
        case 2:
          if (Hl(a, b, a.fb)) {
            e.v(4);
            break;
      ...
      return y(function (l) {
        switch (l.g) {
          case 1:
            ...
            if (
              !(
                (a.A && a.A('nwl_consider_error_code') && g) ||
                (a.A &&
                  !a.A('nwl_consider_error_code') &&
                  a.potentialEsfErrorCounter <= a.Ca)
              )
            ) {
              l.v(2);
              break;
          ...
          case 2:
            ...
            return b.sendCount < a.hb
              ? x(l, a.C.Oa(b.id, a.u), 12)
              : x(l, a.C.ba(b.id, a.u), 8);
          case 12:
            a.J.P(function () {
              a.F.I() && a.ma();
            }, a.gb);
    ...
    a.C.Va('QUEUED', a.u).then(function (b) {
      b && !Hl(a, b, a.eb)
        ? a.J.P(function () {
            return y(function (c) {
              if (1 == c.g)
                return void 0 === b.id ? c.v(2) : x(c, a.C.Oa(b.id, a.u), 2);
              El(a);
              c.g = 0;
            });
          })
          ...
          function (e) {
            ...
            return f.get(a).then(function (g) {
              if (g)
                return (
                  (g.status = 'QUEUED'),
                  Bj(f.g.put(g, void 0)).then(function () {
                    return g;
                  })
                );
            });
          ...
          function (f) {
            ...
            return g.get(a).then(function (h) {
              return h
                ? ((h.status = 'NEW'),
                  c && (h.sendCount += 1),
                  Bj(g.g.put(h, void 0)).then(function () {
                    return h;
                  }))
                : uj.resolve(void 0);
            });
  ...
  function Pl(a) {
    if (!T('nwl_csi_killswitch') && 0.01 >= Math.random()) {
  ...
  function lm() {
    ...
    a.call(Bl, this, {
      ...
      A: T,
      ha: !(
        Vi() && 'www.youtube-nocookie.com' !== Vb(document.location.toString())
      ),
    });
    this.i = new qg();
  ...
  function nm() {
    ...
    a ||
      ((a = new lm()),
      B('yt.networklessRequestController.instance', a),
    ...
    if (c && 0 === Object.keys(b).length) {
      ...
      if (a)
        if (e) Di(a, void 0, 'POST', e);
          ...
          Di(a, void 0, 'GET', '', void 0, void 0, f);
        else {
          b: {
            try {
              var g = new Za({
  ...
  function Al(a, b, c, d) {
    function e(w) {
      ...
      try {
        w && d.retry && !d.bb.bypassNetworkless
          ? ((g.method = 'POST'),
            d.bb.writeThenSend
              ? nm().writeThenSend(q, g)
              : nm().sendAndWrite(q, g))
        ...
        if ('InvalidAccessError' == M.name)
          A && (yl(A), (A = 0)),
            Uh(Error('An extension is blocking network request.'));
        else throw M;
      }
      A &&
        Pi(function () {
    ...
    !R('VISITOR_DATA') &&
      ...
      0.01 > Math.random() &&
      Uh(
        new Ui('Missing VISITOR_DATA when sending innertube request.', b, c, d)
      );
    if (!a.isReady()) {
  ...
  tm.prototype.Z = function () {
    if (this.g) {
      ...
      if (0 != this.l) {
        ...
        this.h[this.j] = 0.5 < Math.abs((d - this.s) / this.s) ? 1 : 0;
  ...
  function wm() {
    ...
    var a = Date.now();
    B('_lact', a, window);
    -1 == C('_fact', window) && B('_fact', a, window);
  ...
  function Fm(a, b) {
    ...
    for (var e = [], f = 0; f < d.length; f++) {
      ...
      if (Gm(b.auth, g[0])) {
        var h = b.isJspb;
        Gm(void 0 === h ? 'undefined' : h ? 'true' : 'false', g[1]) &&
          Gm(b.cttAuthInfo, g[2]) &&
          e.push(d[f]);
      }
    }
    return (a.g[c] = e);
  ...
  function Vm(a, b) {
    T('web_all_payloads_via_jspb') &&
      Uh(new Ui('transport.log called for JSON in JSPB only experiment'));
    if ('log_event' === a.endpoint) {
      ...
      if (T('use_new_in_memory_storage')) {
        ...
        (d = Pm.get(c) || []), Pm.set(c, d), d.push(a.payload), Ym(b, d, c);
    }
  }
  ...
  function Ym(a, b, c, d, e) {
    ...
    b >= a
      ? T('background_thread_flush_logs_due_to_batch_limit')
        ? Nm ||
          (Nm = $m(function () {
            an(
              {
              ...
              T('flush_only_full_queue') ? c : void 0,
              d
            );
            Nm = void 0;
          }, 0))
      ...
      : 10 <= f - g && (bn(d), d ? (Mm.i = f) : (Lm.i = f));
  }

  function cn(a, b) {
    T('web_all_payloads_via_jspb') &&
      Uh(
        new Ui('transport.logIsolatedGelPayload called in JSPB only experiment')
      );
    if ('log_event' === a.endpoint) {
      Wm(a);
      var c = Xm(a),
  ...
  function Xm(a, b) {
    ...
    if (a.ga) c = 'visitorOnlyApprovedKey';
      ...
      if (void 0 === b ? 0 : b) {
        ...
        c.videoId
          ? kd(d, 1, Gh, c.videoId)
          : c.playlistId && kd(d, 2, Gh, c.playlistId);
        Sm[b] = d;
      } else
        (b = a.cttAuthInfo),
          (c = {}),
  ...
  function an(a, b, c) {
    ...
    !c &&
      T('web_all_payloads_via_jspb') &&
      Uh(new Ui('transport.flushLogs called for JSON in JSPB only experiment'));
    new rg(function (d, e) {
      ...
      if (Jm && Jm.isReady())
        if (T('use_new_in_memory_storage')) {
          ...
          if (void 0 !== b)
            g
              ? ((e = Um().extractMatchingEntries({
                  isJspb: g,
                  cttAuthInfo: b,
                })),
                k.set(b, e),
                fn(k, h, d, f))
              : ((k = Um().extractMatchingEntries({
                  isJspb: g,
                  cttAuthInfo: b,
                })),
                l.set(b, k),
            ...
            for (g = e.next(); !g.done; g = e.next())
              (l = g.value),
                (g = Um().extractMatchingEntries({
                  isJspb: !0,
                  cttAuthInfo: l,
                })),
                0 < g.length && k.set(l, g),
                delete Tm[l];
            fn(k, h, d, f);
          } else {
            k = u(Object.keys(Tm));
            ...
            void 0 !== b
              ? k
                ...
                : ((k = new Map()),
                  ...
                  Pm.delete(b))
              : k
              ? (fn(Qm, h, d, f), Qm.clear())
              : (dn(Pm, h, d, e, f), Pm.clear());
      else bn(c), d();
    });
  }
  ...
  function In(a, b, c, d) {
    if (a)
      if (Array.isArray(a)) {
        ...
        for (
          d = 0;
          d < a.length && !(a[d] && ((e += Jn(d, a[d], b, c)), 500 < e));
          d++
        );
        d = e;
          ...
          if (a[e]) {
            ...
            g =
              ...
              ('clickTrackingParams' !== e && 'trackingParams' !== e)
                ? 0
                : (f = Gn(atob(f.replace(/-/g, '+').replace(/_/g, '/'))))
                ? Jn(e + '.ve', f, g, h)
                : 0;
            d += g;
            d += Jn(e, a[e], b, c);
  ...
  function Un(a) {
    return (
      Tn[a] ||
      (Tn[a] = String(a).replace(/\-([a-z])/g, function (b, c) {
      ...
      ci(window, 'message', function (d) {
        a: {
          if (d.origin === bo(a, 'host')) {
            ...
            if ((d = eo[e.id]))
              (d.s = !0),
                d.s && (E(d.l, d.sendMessage, d), (d.l.length = 0)),
                d.Qa(e);
          }
          e = void 0;
        }
  ...
  function go(a, b, c) {
    ...
    if ((a = 'string' === typeof a ? c.getElementById(a) : a))
      if (
        ...
        b.host || (b.host = c ? Wb(a.src) : 'https://www.youtube.com'),
        (this.h = new ao(b)),
        c ||
          ((b = ho(this, a)),
          (this.m = a),
  ...
  function ho(a, b) {
    ...
    (b = bo(a.h, 'height')) && c.setAttribute('height', b.toString());
    var g = a.Ta();
    ...
    window.location.href &&
      E(['debugjs', 'debugcss'], function (k) {
        var l = $b(window.location.href, k);
        null !== l && (g[k] = l);
      });
    var h =
      '' + bo(a.h, 'host') + ('/embed/' + bo(a.h, 'videoId')) + '?' + Yb(g);
    fo.yt_embedsEnableUaChProbe
      ? Sn().then(function (k) {
          var l = new URL(h),
      ...
      : fo.yt_embedsEnableIframeSrcWithIntent
      ? Pd(c, $d(h))
      : (c.src = h);
    return c;
  }
                ...
                if (!(5 <= Mn)) {
                  ...
                  if (t.hasOwnProperty('args') && t.args && t.args.length)
                    for (
                      var sa = 0;
                      sa < t.args.length &&
                      !((ya = In(t.args[sa], 'params.' + sa, q, ya)),
                      500 <= ya);
                      sa++
                    );
                  ...
                  if (Pn.length)
                    for (
                      var X = 0;
                      X < Pn.length &&
                      !((ya = In(Pn[X], 'params.context.' + X, q, ya)),
                      500 <= ya);
                      X++
                    );
                  navigator.vendor &&
                    !q.hasOwnProperty('vendor') &&
                    (q['device.vendor'] = navigator.vendor);
                  var S = {
                      message: A,
                      name: G,
                      lineNumber: O,
                  ...
                  if ('IGNORED' === t.level) m = 0;
                    ...
                    a: {
                      for (
                        var Hj = En(), Ij = u(Hj.U), Lf = Ij.next();
                        !Lf.done;
                        Lf = Ij.next()
                      ) {
                        var Jj = Lf.value;
                  ...
                  for (
                    ...
                    if (Of.Ba[S.name])
                      for (
                        var Nj = u(Of.Ba[S.name]), Pf = Nj.next();
                        !Pf.done;
                        Pf = Nj.next()
                      ) {
                        var Oj = Pf.value,
                        ...
                        if (Nd) {
                          ...
                          for (
                            var Qf = Oj.groups, Pj = {}, Ob = 0;
                            Ob < Qf.length;
                            Ob++
                          )
                            (Pj[Qf[Ob]] = Nd[Ob + 1]),
                              (S.params['params.error.' + Qf[Ob]] = Nd[Ob + 1]);
                          S.message = Of.La(Pj);
                          break;
                        }
                      }
                  ...
                  S.params['params.errorServiceSignature'] =
                    'msg=' + Qj.U.length + '&cb=' + Qj.S.length;
                  S.params['params.serviceWorker'] = 'false';
                  z.document &&
                    z.document.querySelectorAll &&
                    (S.params['params.fscripts'] = String(
                      document.querySelectorAll('script:not([nonce])').length
                    ));
                  yb('sample').constructor !== xb &&
                    (S.params['params.fconst'] = 'true');
                  var va = S;
                  window.yterr &&
                  ...
                  if (0 !== va.sampleWeight && !Ln.has(va.message)) {
                      ...
                      a: {
                        ...
                        if (T('errors_via_jspb')) {
                          if (Rn()) Tf = void 0;
                            ...
                            var Ja =
                              Q.lineNumber && Q.lineNumber.split
                                ? Q.lineNumber.split(':')
                                : [];
                            0 !== Ja.length &&
                              (1 !== Ja.length || isNaN(Number(Ja[0]))
                                ? 2 !== Ja.length ||
                                  isNaN(Number(Ja[0])) ||
                                  isNaN(Number(Ja[1])) ||
                                  (J(Pb, 2, Number(Ja[0])),
                            ...
                            for (
                              var Xj = R('FEXP_EXPERIMENTS', []), Vf = 0;
                              Vf < Xj.length;
                              Vf++
                            ) {
                              var Yj = sb,
                            ...
                            if (!Ph() && Wf)
                              for (
                                var Zj = u(Object.keys(Wf)), tb = Zj.next();
                                !tb.done;
                                tb = Zj.next()
                              ) {
                                var ak = tb.value,
                          ...
                          if (Rn()) Sf = void 0;
                            ...
                            var Ka =
                              Q.lineNumber && Q.lineNumber.split
                                ...
                                : [];
                            0 !== Ka.length &&
                              (1 !== Ka.length || isNaN(Number(Ka[0]))
                                ? 2 !== Ka.length ||
                                  isNaN(Number(Ka[0])) ||
                                  isNaN(Number(Ka[1])) ||
                                  ((Jc.lineNumber = Number(Ka[0])),
                                  (Jc.columnNumber = Number(Ka[1])))
                                : (Jc.lineNumber = Number(Ka[0])));
                            var bg = {
                            ...
                            'ERROR' === Ic
                              ? (bg.level = 'ERROR_LEVEL_ERROR')
                              : 'WARNING' === Ic &&
                                (bg.level = 'ERROR_LEVEL_WARNNING');
                            var uo = {
                                isObfuscated: !0,
                                browserStackInfo: Jc,
                              },
                            ...
                            R('FEXP_EXPERIMENTS') &&
                              (Qb.experimentIds = R('FEXP_EXPERIMENTS'));
                            var cg = Oh();
                            if (!Ph() && cg)
                              for (
                                var hk = u(Object.keys(cg)), ub = hk.next();
                                !ub.done;
                                ub = hk.next()
                              ) {
                                var ik = ub.value;
                        ...
                        if (
                          ...
                          b: if (T('migrate_events_to_ts'))
                            c: {
                              if (
                                T('web_fp_via_jspb') &&
                                (un(!0), !T('web_fp_via_jspb_and_json'))
                              )
                                break c;
                              un();
                            }
                    ...
                    if (!T('suppress_error_204_logging')) {
                      ...
                      if (Ya.postParams) {
                        ...
                        for (
                          var ok = u(Object.keys(Kc)), eg = ok.next();
                          !eg.done;
                          eg = ok.next()
                        ) {
                          var pk = eg.value;
                        ...
                        if (fg)
                          for (
                            var qk = u(Object.keys(fg)), gg = qk.next();
                            !gg.done;
                            gg = qk.next()
                          ) {
                            var rk = gg.value;
                        ...
                        sk &&
                          tk &&
                          ((Ya.postParams['server.name'] = sk),
                          (Ya.postParams['server.version'] = tk));
                      }
  ...
  n.Qa = function (a) {
    ...
    switch (b) {
      case 'apiInfoDelivery':
        if (Pa(a)) for (var c in a) a.hasOwnProperty(c) && (this.M[c] = a[c]);
        break;
      case 'infoDelivery':
        qo(this, a);
        break;
    ...
    if (Pa(b)) {
      ...
      a.playerInfo.hasOwnProperty('videoData') &&
        ...
        b.hasOwnProperty('title') && b.title
          ...
          : ((a.videoTitle = ''),
            a.g.setAttribute('title', 'YouTube ' + bo(a.h, 'title'))));
    }
  }
