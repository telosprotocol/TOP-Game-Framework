  ...
  >
    ...
    >
      <template v-if="taskRightInfo.type === 'button'">
        ...
        <button
          @click="onTaskClick"
          class="vbtn vbtn--sm w-[72px] active:scale-95"
...
export default class GrowthTaskItem extends mixins(VTaskItemMixin) {
  get propList() {
  ...
  async onTaskClick() {
    emitGBus('dealTaskLogic', {
      ...
      taskModuleType: 'GROWTH_PLAN_GROWTH_PLAN',
    });
  }
}
</script>
